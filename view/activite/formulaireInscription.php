...
<fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select name="PRESENCE">
                    <option value="0">Sans Adulte</option>
                    <option value="1">Avec 1 Adulte</option>
                    <option value="2">Avec 2 Adultes</option>
                </select>
            </div>
        </div>  
        <div class="form-group">
        ...
        <td><button id="singlebutton" name="singlebutton" class="btn btn-info" onclick="window.location.href = '../listerActivite'">Annuler</button></td>
