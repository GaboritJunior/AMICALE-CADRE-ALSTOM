<form class="form-horizontal" method="post" action="<?= BASE_URL ?>/activiteLeader/nouveau">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-2 control-label" for="textinput">Numéro matricule :</label>  
            <div class="col-md-4">
                <input id="PRENOM_LEADER" name="NumMatri_LEADER" placeholder="N° matricule" class="form-control input-md" type="NumMatri_LEADER" value="<?= (isset($_SESSION['MATRICULE']) ? $_SESSION['MATRICULE'] : 'ERREUR') ?>"readonly>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <div class="col-md-9 bg-info">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="textinput">Coût Enfant :</label>  
                        <div class="col-md-4">
                            <input id="COUT_ENFANT" name="COUT_ENFANT" placeholder="COUT_ENFANT" class="form-control input-md" type="number" value="<?= (isset($activite->COUT_ENFANT) ? $activite->COUT_ENFANT : '') ?>">
                        </div>
                    </div>
                </div>
            </div>
