...
//recup les données du formulaire
        ...
        $donnees["STATUT"] = 'A';
        $colonnes = array('ID_DOMAINE', 'ID_LEADER', 'ID_PRESTATAIRE', 'NOM', 'DETAIL', 'DATE_CREATION', 'ADRESSE', 'VILLE', 'CP', 'INDICATION_PARTICIPANT', 'INFO_IMPORTANT_PARTICIPANT', 'FORFAIT', 'TARIF_FORFAIT', 'TARIF_UNIT', 'COUT_ADULTE', 'AGE_MINIMUM', 'COUT_ENFANT', 'OUVERT_EXT', 'STATUT');
...
//    }
    public function liste() {
        ...
        $projection['projection'] = "ID_LEADER,ID_ACTIVITE,NOM,DETAIL,ADRESSE,CP,VILLE,INDICATION_PARTICIPANT,INFO_IMPORTANT_PARTICIPANT,AGE_MINIMUM,FORFAIT,TARIF_FORFAIT,TARIF_UNIT,OUVERT_EXT,COUT_ADULTE,COUT_ENFANT,STATUT";
        $projection['conditions'] = "ID_LEADER = " . $_SESSION['ID_ADHERENT'];
        $d['activiteleader'] = $modActiviteLeader->find($projection);
